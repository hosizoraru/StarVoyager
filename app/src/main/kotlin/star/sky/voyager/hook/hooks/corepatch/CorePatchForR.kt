...
open class CorePatchForR : XposedHelper(), IXposedHookLoadPackage, IXposedHookZygoteInit {
    ...
    override fun handleLoadPackage(loadPackageParam: XC_LoadPackage.LoadPackageParam) {
        Log.d(CorePatchMainHook.TAG, "down_grade" + prefs.getBoolean("down_grade->", true))
        Log.d(CorePatchMainHook.TAG, "auth_creak" + prefs.getBoolean("auth_creak->", true))
        ...
        hookAllMethods(
            ...
            ReturnConstant(prefs, "down_grade", true)
        )
        ...
        findAndHookMethod(
            ...
            ReturnConstant(prefs, "auth_creak", 0)
        )
        findAndHookMethod(
